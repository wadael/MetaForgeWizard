== MetaForgeWizard
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The MetaForgeWizard addon enables blah blah...)
...
----
<dependency>
   <groupId>org.wadael.forge.metaforgewizard</groupId>
   <artifactId>MetaForgeWizard</artifactId>
